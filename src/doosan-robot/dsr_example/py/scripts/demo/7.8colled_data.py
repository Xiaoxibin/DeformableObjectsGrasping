...
def current_pos():
    ...
    with open('/home/hrc/Projects/catkin_ws/src/doosan-robot/realdata/collect_pos_vir.txt', 'w') as f:
           while True:
...
def do_pos():
    ...
    start_pos = posj(-9.84,-29.58,118.58,14.48,38.18,-25.21)
    r1.movej(start_pos, vel=10, acc=5)
...
##################
    ...
    via_point1 = posx(346.07,-23.92,517.37,176.94,-121.62,169.98)
    via_point2 = posx(578.73,-64.37,468.01,178.53,-127.29,171.27)
    # via_point3 = posx(794.05,-2.81,325.82,10.16,119.02,0.64)
    
    goal_pose = posx(goal_pose[0], goal_pose[1], goal_pose[2]+10, 3.70, 129.310, 6.02)
    print("goal_pose: ", goal_pose)
    xlist = [via_point1,via_point2,goal_pose] 
    r1.movesx(xlist, vel=[20, 10], acc=[10, 7], vel_opt=DR_MVS_VEL_NONE) 
